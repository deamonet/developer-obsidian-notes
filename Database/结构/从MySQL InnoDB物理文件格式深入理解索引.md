[![logo](media/logo.png)](http://neoremind.com/ "Neo的技术博客")
...
文章中类似风格的图片引用自[JCole的博客](https://blog.jcole.us/innodb/)。
